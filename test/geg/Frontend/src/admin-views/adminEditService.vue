            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-10">
               <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4">
                  <div class="justify-left max-w-full mx-auto flex">
                     <form id="editService" class="relative bg-white rounded-lg shadow dark:bg-gray-700 w-full">
                        <!-- Modal header -->
                              ...
                              <div class="p-6 space-y-6">
                                 <div class="grid grid-cols-6 gap-6">
                                       <div class="col-span-6 sm:col-span-6">
                                          ...
                                          <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="user_avatar_help" name="service-picture" id="service-picture" type="file">
                                       </div>
                                       <div class="col-span-6 sm:col-span-6">
...
export default defineComponent({
   mounted() {
        document.getElementById('editService').addEventListener('submit', (event) => {
            event.preventDefault(); 
            const formData = new FormData(event.target);
            const Title = formData.get("title");
            const Description = formData.get("description"); 
            const Image = formData.get('service-picture'); 
